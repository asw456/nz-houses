...
interest <- data.table(read.table("/Users/james/development/code_personal/nz-houses/data/math/mortgage_rates_historical.csv", header = FALSE, sep="\t", col.names=colnames))
...
w#rite.table(a,"/Users/james/development/code_personal/nz-houses/data/math/interest_rate_walk_probabilities.txt", row.names=FALSE, col.names=FALSE,na="-99",sep="\t")
