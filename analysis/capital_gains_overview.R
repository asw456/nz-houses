...
house_price_index <- data.table(read.table("/Users/james/development/code_personal/nz-houses/data/math/house_price_index_start_1963Q2.txt", header = FALSE, sep="\t", col.names=colnames))
...
write.table(a,"/Users/james/development/code_personal/nz-houses/data/math/interest_rate_walk_probabilities.txt", row.names=FALSE, col.names=FALSE,na="-99",sep="\t")



# ================ interest generated by python random walk script =================

interest_generated <- data.table(read.table("/Users/james/development/code_personal/nz-houses/data/math/interest_rate_array.txt", header = FALSE))
...
#z <- read.zoo("/Users/james/development/code_personal/nz-houses/data/mortgage_rates_historical.csv", sep = '\t', format = "%d-%b-%Y")
